              ...
              <v-card-text>
                <v-list>
                  <v-list-item v-for="rental in rentals" :key="rental.id">
                    <v-list-item-content>
                      <v-list-item-title>{{ rental.name }}</v-list-item-title>
                      <v-list-item-subtitle>{{ rental.date }}</v-list-item-subtitle>
                      <v-list-item-subtitle>Status: {{ rental.status }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-card-text>
                ...
                <v-list>
                  <v-list-item v-for="payment in payments" :key="payment.id">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle>Valor: {{ payment.amount }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-card-text>
...
export default class UserPanel extends Vue {
  ...
  public rentals: any[] = [
    { id: 1, name: 'Pista A', date: '2025-03-18', status: 'Ativa' },
    { id: 2, name: 'Pista B', date: '2025-03-19', status: 'Concluída' },
    { id: 3, name: 'Pista C', date: '2025-03-19', status: 'Concluída' },
    { id: 4, name: 'Pista D', date: '2025-03-19', status: 'Concluída' },
  ];
